...
const Login = () => {
  ...
  return (
    ...
    <div className="flex min-h-full flex-col justify-center px-6 lg:py-12 py-6 lg:px-8 bg-pink-50  ">
      <ToastContainer />
      <div className="border mx-auto  shadow-lg shadow-pink-200 md:w-[55vh] w-full  bg-gradient-to-r from-fuchsia-100 via-fuchsia-200 to-fuchsia-300 rounded-xl  p-8">
  <div className="sm:mx-auto sm:w-full sm:max-w-sm">
    <img className="mx-auto h-44 w-56 border border-orange-500" src="/singh_store1.jpeg" alt="Your Company" />
    <h2 className="mt-6 text-center lg:text-3xl text-2xl font-semibold leading-9  tracking-tight text-gray-900">Login</h2>
  </div>
  <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <div className="relative">
      ...
      <div className='flex '>
        <h2 className='my-2 sm:text-lg text-md'> Create account <Link className='font-semibold underline text-md mx-1' href={'/signup'}> Sign Up</Link></h2>
        <h2 className='my-2 sm:text-lg text-md'><Link className='font-semibold underline mx-1 ' href={'/forgetpassword'}>Forget Password</Link></h2>
      </div>
      <div>
