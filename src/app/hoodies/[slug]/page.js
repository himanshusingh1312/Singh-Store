...
const Hoodieslug= (props) => {
 ...
 useEffect(()=>{
  ...
  const getProductDetail = async()=>{
    setLoading(true)
    let productdata= await fetch(`http://localhost:3000/api/hoodiesapi/${productid}`)
  ...
  return (
     <div>
    <section className="text-white body-font overflow-hidden bg-[url('/store10.jpg')] border border-black brightness-90" >
    <ToastContainer />
    {loading && (
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 md:bg-opacity-30 md:backdrop-blur-md">
            ...
            <div className="flex mb-4">
              <span className="flex items-center">
                ...
                <span className="text-xl ml-3 text-white">4 Reviews</span>
              </span>
            ...
            <p className="leading-relaxed font-bold text-2xl text-white">Size : {size}</p>
          
            <p className="title-font font-medium text-2xl text-white">Price :{price}</p>
